...
class CineZoneDetailScreen extends StatefulWidget {
  CineZoneCover cineZoneCover;
  CineZoneDetailScreen({super.key, required this.cineZoneCover});

  @override
  State<CineZoneDetailScreen> createState() => _CineZoneDetailScreenState();
}

class _CineZoneDetailScreenState extends State<CineZoneDetailScreen> {

  CineZoneDetailController cineZoneDetailController = Get.put(CineZoneDetailController());
  @override
  void initState() {
    super.initState();
  }
    ...
    return /*BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      builder: (context, moviestate) {
        if (moviestate is MovieDetailsLoading) {
          ...
          return*/ Scaffold(
        body: FutureBuilder<CineZoneDetail>(
            future: cineZoneDetailController.getMovieDetail(widget.cineZoneCover!)!,
                ...
                return CustomScrollView(
                  slivers: [
                    SliverAppBar(
                      ...
                      flexibleSpace: CineZoneCustomFlexibleSpaceBar(cineZoneDetail: snapshot.data!,),
                      expandedHeight: 65.h,
                    ),
                    SliverList(
                              ...
                              children: [
                                ...
                                Center(
                                  child: CustomButton(func: () async {
                                    ...
                                    Map<String,Map<String,String>> map = await  cineZoneDetailController.getVideoLinks(serverId,isTvShow: isTvshow);
                                    LoaderDialog.stopLoaderDialog();
                                    ServerListDialog.showServerListDialog(navigatorKey.currentContext!, map,widget.cineZoneCover.title!,isDirectPlay: true,isNativemxPlayer: false);
