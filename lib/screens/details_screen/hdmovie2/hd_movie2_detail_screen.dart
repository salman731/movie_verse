                               ...
                               /* if(allMovieLandDetailController.isSeries)...[
                                ...
                                Center(
                                  child: CustomButton(func: () async{
                                    ...
                                    ServerListDialog.showServerListDialog(navigatorKey.currentContext!,map.$2,widget.hdMovie2Cover.title!,headers: {"Referer":map.$1},isDirectPlay: true,isNativemxPlayer: true);
                                  }, title: "Play",
                                    color: AppColors.red,
